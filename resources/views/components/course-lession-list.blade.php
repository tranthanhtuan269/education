                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-8">
                                            <div class="title">
                                                <a>
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i> Bài 1: Nguyên âm </a>
                                            </div>
                                        </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-8">
                                            <div class="title">
                                                <a>
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i> Bài 2: Phụ âm</a>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-md-2">
                                            <div class="link">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-8">
                                            <div class="title">
                                                <a>
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i> Bài 3: Phân biệt phát âm phụ âm nhẹ, phụ âm đôi và phụ âm bật hơi</a>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-md-2">
                                            <div class="link">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-8">
                                            <div class="title">
                                                <a>
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i> Bài 4: Cách phát âm patchim (Phụ âm cuối)</a>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-md-2">
                                            <div class="link">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-8">
                                            <div class="title">
                                                <a>
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i> Bài 5: Ghép chữ và đánh vần như tiếng Việt </a>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-md-2">
                                            <div class="link">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-8">
                                            <div class="title">
                                                <a>
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i> Bài 6: Cách nối âm và thứ tự câu trong tiếng Hàn</a>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-md-2">
                                            <div class="link">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-8">
                                            <div class="title">
                                                <a>
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i> Bài 9: Quốc gia, nghề nghiệp</a>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-md-2">
                                            <div class="link">
