...
<div class="collapse navbar-collapse" id="myNavbar">
    <ul class="nav nav-tabs" style="border-bottom: 0px !important">
        ...
        <li class="@if(Request::is('user/student/course')) active  @endif"><a href="{{ url('user/student/course') }}" ><i class="fa fa-book" aria-hidden="true"></i> Khóa học</a></li>
        ...
        <li class="@if(Request::is('user/student/order-logs')) active  @endif">
            <a href="{{ url('user/student/order-logs') }}" class=""> <i class="fa fa-history" aria-hidden="true"></i> Lịch sử giao dịch</a>
        </li>
