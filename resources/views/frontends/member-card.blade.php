    ...
    <div class="member-card-offer">
        ...
        <div class="row">
            <div class="col-sm-6 box-offer-l">
                ...
                <div class="info">
                    <p class="dollar">$50 - Courdemy Online Courses</p>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="valid">
            ...
            <div class="col-sm-6 box-offer-r">
                ...
                <div class="info">
                    <p class="dollar">$25 - Courdemy Online Courses</p>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="valid">
                                <img src="{{asset('frontend/images/member-card-check-mark.png')}}" alt="Check Mark" title="Check Mark">
        ...
        <div class="row">
            <div class="col-sm-6 box-offer-l">
                ...
                <div class="info">
                    <p class="dollar">$10 - Courdemy Online Courses</p>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="valid">
                                <img src="{{asset('frontend/images/member-card-check-mark.png')}}" alt="Check Mark" title="Check Mark">
            ...
            <div class="col-sm-6 box-offer-r">
                ...
                <div class="info">
                    <p class="dollar">$5 - Courdemy Online Courses</p>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="valid">
                                <img src="{{asset('frontend/images/member-card-check-mark.png')}}" alt="Check Mark" title="Check Mark">
